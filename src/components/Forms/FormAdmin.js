...
const FormAdmin = ({ initialValues, validationSchema, submitForm, type }) => {
  return (
    <StyledContainerFormPage>
      <StyledFormContainer>
        <StyledFormTitle>
            ...
            <StyledBoxForm onSubmit={handleSubmit} noValidate>
              ...
              <StyledBoxInput>
                ...
                {errors.desc && touched.desc && (
                  <StyledPError>{errors.desc}</StyledPError>
                )}
              </StyledBoxInput>
              ...
              <StyledBoxInput>
                ...
                {errors.type && touched.type && (
                  <StyledPError>{errors.type}</StyledPError>
                )}
              </StyledBoxInput>
              ...
              <StyledBoxInput>
                ...
                {errors.category && touched.category && (
                  <StyledPError>{errors.category}</StyledPError>
                )}
              </StyledBoxInput>

              <StyledButton>{type === "add" ? "Add" : "Save"}</StyledButton>
            </StyledBoxForm>
          )}
        </Formik>
      </StyledFormContainer>
